...
export default function ProjectsSection({ projects }) {
 ...
 animate-fadeIn">
      <div className="border-2 border-cyan-400/30 bg-gradient-to-br from-black/80 via-cyan-950/10 to-black/80 p-12 backdrop-blur-xl shadow-2xl shadow-cyan-400/30">
        ...
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-12 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 flex items-center gap-4">
          <Rocket
 ...
 hover:border-cyan-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-500/30 backdrop-blur-xl"
            ...
            >
              ...
              {/* Description */}
              <p className="text-cyan-200 mb-6 text-base sm:text-lg leading-relaxed">
              ...
              <div className="space-y-3 mb-6">
                ...
                {project.highlights.map((highlight, j) => (
                  <p
                    key={j}
                    className="text-cyan-200 text-base leading-relaxed flex items-start gap-3"
                  >
              ...
              <div className="flex flex-wrap gap-3">
                {project.tech.map((tech, j) => (
                  <span
                    key={j}
                    className={`px-4 py-2 bg-gradient-to-r ${project.gradient} bg-opacity-10 border-2 border-cyan-400/50 text-cyan-200 text-sm font-semibold rounded hover:border-cyan-400 transition-all duration-300 hover:scale-105 backdrop-blur`}
                  >
                    {tech}
                  </span>
                ))}
